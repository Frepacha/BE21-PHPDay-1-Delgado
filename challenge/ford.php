...
<div class="container d-flex justify-content-center">
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img id="silverfox" src="<?php echo ($cars["Car2"]["image"]);?>" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title text-light fs-4"><?php echo ($cars["Car2"]["Branch"]);?> <?php echo ($cars["Car2"]["Model"]);?> </h5>
        ...
        <p class="card-text text-light fs-4"><?php echo ($cars["Car2"]["Price"]);?> $</p>
      </div>
    </div>
  </div>
</div>
